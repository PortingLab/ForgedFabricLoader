...
public class FMLModMetadata implements ModMetadata {
    ...
    public FMLModMetadata(ModInfo modInfo) {
        this.modInfo = modInfo;
        this.version = uncheck(() -> Version.parse(this.modInfo.getVersion().toString()));
        this.authors = modInfo.getOwningFile().getConfigElement("authors").stream()
    ...
    public Collection<String> getProvides() {
        List<String> modProvides = this.modInfo.<List<String>>getConfigElement("provides").orElseGet(List::of);
